...
(function() {
  ...
  const navItems = [
    ...
    { label: 'Interview Prep', href: '/interview-prep.html', icon: '🎯' },
    { label: 'Story Bank', href: '/story-bank.html', icon: '📚' },
    { label: 'Resume', href: '/resume-leveling.html', icon: '📄' },
    { label: 'LinkedIn', href: '/linkedin-scoring.html', icon: '💼' },
