...
**Goal**: Honest assessment + concrete preparation requirements

**Format**:
```
"You have [strength], but this role favors [what's missing]. The 
opportunity is viable if [conditions]. Before applying, [specific 
preparation steps]. Once positioned correctly, [outreach guidance]."
```
...
your consumer impact and experimentation depth. Before applying, update 
your resume to emphasize customer problem-solving, cross-functional work 
with support teams, and any self-service initiatives. Once positioned 
correctly, apply and reach out to the hiring manager."
```
...
**Goal**: Reality check + alternative path guidance

**Format**:
```
"This is a significant stretch. [Gap explanation]. Consider [alternative 
path or role that's a better fit]."
```

**Example**:
```
"This is a significant stretch for your current experience level. The 
role requires 10+ years at Staff/Principal scope, and you're at 8 years 
Senior-level experience. Consider targeting Senior PM roles first to 
build the organizational influence and multi-quarter roadmap ownership 
this level demands."
```

**Tone**: Direct, honest, helpful redirection
...
**Goal**: Clear "no" + redirection to better opportunities

**Format**:
```
"Do not apply to this role. [Clear explanation why]. Focus on [what 
...
Senior Product Management, not backend engineering. Focus on Senior PM 
opportunities in delivery, logistics, or platform companies like Uber 
or DoorDash, where your 8 years of product leadership are directly relevant."
```
